...
- **Camera circling in busy fights, and not finding the ball at round start** — searching for a ball that isn't after you is now one sweep of about 1.5 seconds, once it has been missing for 1 second, stopped as soon as the ball is found, and at most once every 6 seconds. Searching every time chained into circling. Switching searching off entirely, tried briefly, left the ball unfound at the start of rounds (seen in 12% of frames instead of about 60%), so the AI barely moved.
