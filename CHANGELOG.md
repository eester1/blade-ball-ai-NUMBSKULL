...
- **Spam block in fast exchanges now triggers only when you're targeted again within 0.9 s** (was 1.2 s): in the logs, those exchanges died 35% of the time against 19% for 0.9–1.2 s.
